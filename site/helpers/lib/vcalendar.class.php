...
class vcalendar extends iCalBase
{
     ...
     * @param bool|int $startD optional, start Day,   default current Day
     * @param bool|int $endY optional, end   Year,  default $startY
     * @param bool|int $endM optional, end   Month, default $startM
     * @param bool|int $endD optional, end   Day,   default $startD
