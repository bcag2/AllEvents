...
class ICal
{
     ...
     * @param bool $filename
     *
     * @internal param $ {mixed} $filename The path to the iCal-file or an array of lines from an iCal file $filename The path to the iCal-file or an array of lines from an iCal file
     *
     */
     ...
     *
     * @return array|bool {array} array("VCALENDAR", "Begin")
     ...
     * @param $value
     *
     * @internal param $ {string} $component This could be VTODO, VEVENT, VCALENDAR, ... $component This could be VTODO, VEVENT, VCALENDAR, ...
     * @internal param $ {string} $keyword   The keyword, for example DTSTART $keyword   The keyword, for example DTSTART
     * @internal param $ {string} $value     The value, for example 20110105T090000Z $value     The value, for example 20110105T090000Z
     *
     */
        ...
        switch ($component) {
            ...
            case 'VEVENT':
                if (!isset($this->cal[$component][$this->event_count - 1][$keyword . '_array'])) {
                    $this->cal[$component][$this->event_count - 1][$keyword . '_array'] = []; // Create array()
                }
                ...
                if (is_array($value)) {
                    ...
                    if ($this->cal[$component][$this->event_count - 1][$keyword] != $value) {
                        ...
                        if (in_array($ord, [9, 32])) { // Is space or tab?
    ...
    public function process_recurrences()
    {
        ...
        foreach ($array['VEVENT'] as $anEvent) {
            if (isset($anEvent['RRULE']) && $anEvent['RRULE'] != '') {
                ...
                if (in_array($frequency, ['MONTHLY', 'YEARLY']) && isset($rrules['BYDAY']) && $rrules['BYDAY'] != '') {
                    // Deal with BYDAY
     ...
     *
     * @return array|bool
     * @internal param $ {boolean} $rangeStart Either true or false $rangeStart Either true or false
     * @internal param $ {boolean} $rangeEnd   Either true or false $rangeEnd   Either true or false
     *
     */
