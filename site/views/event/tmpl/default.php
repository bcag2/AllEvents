...
if (($this->params["controlpanel_showplanifications"]) && ($user->authorise('core.planifadmin', 'com_allevents'))) {
    require_once JPATH_SITE . '/components/com_contact/models/contact.php';
    require_once JPATH_SITE . '/components/com_allevents/models/place.php';
}
...
<?php if (!empty($item->titre)) : ?>
    ...
    <div class="clearfix" id="aecontent">
                ...
                <div class="wellae">
                    ...
                    foreach ($item->fields as $field) :
                        ...
                        if (!key_exists($field->group_title, $eventFieldGroups)) :
                            $eventFieldGroups[$field->group_title] = [];
                        endif;
        ...
        <?php if (($this->params["controlpanel_showplanifications"]) && ($user->authorise('core.planifmusicians', 'com_allevents'))) : ?>
            <div class="accordion-group accordion-heading accordionae-heading ">
                <a class="accordion-toggle" data-toggle="collapse" aria-expanded="true"
                   aria-controls="#collapseplanifmusicians"
                   href="#collapseplanifmusicians"><?php echo JText::_('COM_ALLEVENTS_TITLE_PLANIFMUSICIANS'); ?><span
                            class="pull-right"><i class="fa fa-plus-square-o"></i></span></a>
            </div>
            <div id="collapseplanifmusicians" class="<?php echo $classcollapse; ?>">
                <div class="accordion-inner wellae">
                    <?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_MUSICIANS'); ?>
                    <br/>

                    <table class="table">
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_MUSICIANS_GOING_TIME'); ?></th>
                            <td><?php echo substr($item->musicians_going_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_MUSICIANS_ARRIVAL_TIME'); ?></th>
                            <td><?php echo substr($item->musicians_arrival_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_MUSICIANS_RETURN_TIME'); ?></th>
                            <td><?php echo substr($item->musicians_return_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_INSTALL_TIME'); ?></th>
                            <td><?php echo substr($item->install_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_SOUND_BALANCE_TIME'); ?></th>
                            <td><?php echo substr($item->sound_balance_time, 0, 5); ?></td>
                        </tr>
                    </table>
                    <div id="event_planification_description">
                        <?php echo $item->planification_description; ?>
                    </div>
                </div>
            </div>
        <?php endif; ?>

        <?php if (($this->params["controlpanel_showplanifications"]) && ($user->authorise('core.planifadmin', 'com_allevents'))) : ?>
            <div class="accordion-group accordion-heading accordionae-heading ">
                <a class="accordion-toggle" data-toggle="collapse" aria-expanded="true"
                   aria-controls="#collapseplanifadmin"
                   href="#collapseplanifadmin"><?php echo JText::_('COM_ALLEVENTS_TITLE_PLANIFADMIN'); ?><span
                            class="pull-right"><i class="fa fa-plus-square-o"></i></span></a>
            </div>
            <div id="collapseplanifadmin" class="<?php echo $classcollapse; ?>">
                <div class="accordion-inner wellae">
                    <?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_CONTACTS'); ?>
                    <?php $organizer_contact = new ContactModelContact(); ?>
                    <?php $producer_contact = new ContactModelContact(); ?>
                    <?php $soundman_contact = new ContactModelContact(); ?>
                    <?php $steward_contact = new ContactModelContact(); ?>
                    <?php $speaker_contact = new ContactModelContact(); ?>
                    <?php $photographer_contact = new ContactModelContact(); ?>
                    <?php $gathering_place = new AllEventsModelPlace(); ?>

                    <?php if (!empty($item->organizer_contact_id)) {
                        $organizer_contact_item = $organizer_contact->getItem($item->organizer_contact_id);
                    } ?>
                    <?php if (!empty($item->producer_contact_id)) {
                        $producer_contact_item = $producer_contact->getItem($item->producer_contact_id);
                    } ?>
                    <?php if (!empty($item->soundman_contact_id)) {
                        $soundman_contact_item = $soundman_contact->getItem($item->soundman_contact_id);
                    } ?>
                    <?php if (!empty($item->steward_contact_id)) {
                        $steward_contact_item = $steward_contact->getItem($item->steward_contact_id);
                    } ?>
                    <?php if (!empty($item->speaker_contact_id)) {
                        $speaker_contact_item = $speaker_contact->getItem($item->speaker_contact_id);
                    } ?>
                    <?php if (!empty($item->photographer_contact_id)) {
                        $photographer_contact_item = $photographer_contact->getItem($item->photographer_contact_id);
                    } ?>
                    <?php if (!empty($item->gathering_place_id)) {
                        $gathering_place_item = $gathering_place->getData($item->gathering_place_id);
                    } ?>
                    <br/>
                    <table class="table">
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_ORGANIZER_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($organizer_contact_item) ? $organizer_contact_item->name . ' (' . $organizer_contact_item->telephone . ' / ' . $organizer_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_PHOTOGRAPHER_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($photographer_contact_item) ? $photographer_contact_item->name . ' (' . $photographer_contact_item->telephone . ' / ' . $photographer_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_PRODUCER_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($producer_contact_item) ? $producer_contact_item->name . ' (' . $producer_contact_item->telephone . ' / ' . $producer_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_STEWARD_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($steward_contact_item) ? $steward_contact_item->name . ' (' . $steward_contact_item->telephone . ' / ' . $steward_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_SOUNDMAN_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($soundman_contact_item) ? $soundman_contact_item->name . ' (' . $soundman_contact_item->telephone . ' / ' . $soundman_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_SPEAKER_CONTACT_ID'); ?></th>
                            <td><?php echo(isset($speaker_contact_item) ? $speaker_contact_item->name . ' (' . $speaker_contact_item->telephone . ' / ' . $speaker_contact_item->mobile . ')' : ''); ?></td>
                        </tr>
                    </table>

                    <?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_TECHNICIANS'); ?>
                    <br/>

                    <table class="table">
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_TECHNICIANS_GOING_TIME'); ?></th>
                            <td><?php echo substr($item->technicians_going_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_TECHNICIANS_ARRIVAL_TIME'); ?></th>
                            <td><?php echo substr($item->technicians_arrival_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_TECHNICIANS_RETURN_TIME'); ?></th>
                            <td><?php echo substr($item->technicians_return_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_STAGE_AVAILABLE_TIME'); ?></th>
                            <td><?php echo substr($item->stage_available_time, 0, 5); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_CONVEYANCE'); ?></th>
                            <td><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_CONVEYANCE_OPTION_' . $item->conveyance); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_LOCATION'); ?></th>
                            <td><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_LOCATION_OPTION_' . $item->location); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_GATHERING_PLACE_ID'); ?></th>

                            <td><?php
                                if (isset($gathering_place_item)) {
                                    echo "<span class='se_event_info_place se_place_" . $gathering_place_item->id . "_bullet'><a href='" . $gathering_place_item->link . '?Itemid=' . $Itemid . "'>" . $gathering_place_item->titre . "</a><br/></span>";
                                } else {
                                    echo "";
                                }
                        ...
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_ARTETVIE'); ?></th>
                            <td>
                                <?php switch ($item->artetvie) {
                                    case '0' :
                                        echo JText::_('JNO');
                                        break;
                                    case '1' :
                    ...
                    <!--
                    <?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_MONEY'); ?>
                    <br/>

                    <table class="table">
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_PRICE'); ?></th>
                            <td><?php echo $item->service_price . ' ' . $this->params['addcurrency']; ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_TRAVEL_EXPENSES'); ?></th>
                            <td><?php echo $item->travel_expenses . ' ' . $this->params['addcurrency']; ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_CACHET'); ?></th>
                            <td><?php echo $item->service_cachet . ' ' . $this->params['addcurrency']; ?></td>
                        </tr>
                        <tr>
                            <th><?php echo JText::_('COM_ALLEVENTS_PLANIFICATION_PROFIT'); ?></th>
                            <td><?php echo $item->service_profit . ' ' . $this->params['addcurrency']; ?></td>
                        </tr>
                    </table>
-->
                </div>
