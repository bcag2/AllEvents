...
if (!$user->id) {
    ...
    <div style="background-color:#F5F5F5;padding:15px;border-radius:4px;">
        <div align="center" style="color:#FF0000;">
            <span><?php echo JText::_('ALLEVENTS_LOGIN_MSG'); ?> </span>
        </div>
    </div>
    <?php
    return false;
...
<form action="<?php echo JRoute::_('index.php?option=com_allevents', false); ?>" method="post" class="form-validate"
      id="adminForm">
    <fieldset>
                            ...
                            <table id="ticket_info_tab_table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                        ...
                                        <div class="controls">
                                            <div class="input-append">
                                                <input readonly type="text" value="<?php echo $this->item->price; ?>"
                                                       class="input-small" name="price" id="price">
                                    ...
                                    <td data-title="No. of Tickets to Buy">
                                        <input type="text" value="1" onkeyup="checkforalpha(this)"
                                               class="input-small type_ticketcounts changesNo" name="type_ticketcount"
                                               id="type_ticketcount" aria-required="true"
                                               required="required">
                                    </td>
                                    <td data-title="Total Price">
                                        <div class="controls">
                                            <div class="input-append">
                                                <input readonly type="text" value="<?php echo $this->item->price; ?>"
                                                       class="input-small" name="total" id="total">
                                                <span class="add-on"><?php echo $this->params['addcurrency']; ?></span>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="row form-horizontal">
                ...
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="fnam"><?php echo JText::_('COM_ALLEVENTS_USERNAME'); ?>&nbsp; *</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <input type="text" title="Enter User Name" name="bill[fnam]" size="50" maxlength="250"
                               value="<?php echo $user->name . ' (' . $user->username . ')'; ?>"
                               class="input-medium bill inputbox validate-name" id="fnam" aria-required="true"
                               required="required">
                    </div>
                </div>
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="email1"><?php echo JText::_('COM_ALLEVENTS_EMAIL'); ?>&nbsp; *</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12"><input type="email" title="Enter a valid Email"
                                                                               name="bill[email1]" size="32"
                                                                               maxlength="250"
                                                                               value="<?php echo $user->email; ?>"
                                                                               class="input-medium bill inputbox validate-email"
                ...
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="phon"><?php echo JText::_('COM_ALLEVENTS_MOBILE'); ?>&nbsp;</label>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <select data-chosen="com_allevents" class="" id="country_mobile_code"
                            ...
                            <option selected="selected" value="33" data-countrycode="FR">France (+33)</option>
                        ...
                        <input type="text"
                               ...
                               class="input-small bill inputbox validate-integer" id="phon"
                        >
                    </div>
                </div>
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="addr"><?php echo JText::_('PLACES_RUE'); ?>&nbsp;</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <textarea title="Enter Address" rows="3" maxlength="250" name="bill[addr]"
                                  id="addr"></textarea>
                ...
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="zip"><?php echo JText::_('PLACES_CODEPOSTAL'); ?>&nbsp;</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <input type="text" title="Enter your Zip Code" name="bill[zip]" size="32" maxlength="20"
                               onblur="" value="" class="input-small bill inputbox " id="zip"
                        >
                    </div>
                </div>
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="country"><?php echo JText::_('PLACES_PAYS'); ?>&nbsp;</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <select onchange="allevents_generateState('country','',1)" size="1"
                                aria-invalid="false" class="chzn-done jt_select bill"
                ...
                <div class="form-group">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for="city"><?php echo JText::_('PLACES_VILLE'); ?>&nbsp;</label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <input type="text" title="Enter your City" name="bill[city]" size="32" maxlength="250" value=""
                               class="input-medium bill inputbox validate-name" id="city"
                        >
                    </div>
                </div>
                <div class="form-group ">
                    <label class=" col-lg-2 col-md-2 col-sm-3 col-xs-12  control-label"
                           for=""><?php echo JText::_('COM_ALLEVENTS_FIELD_NOTE_LABEL'); ?></label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <div>
        ...
        <input type="hidden" name="event_titre" value="<?php echo $this->item->titre; ?>"/>
    ...
    (function ($) {
        $(document).ready(function () {
            ...
            $(document).on('change keyup blur', '.changesNo', function () {
                var quantity = $('#type_ticketcount').val();
                var price = $('#price').val();
                if (quantity != '' && price != '') {
                    $('#total').val((parseFloat(price) * parseFloat(quantity)).toFixed(2));
                }
                calculateTotal();
            });
