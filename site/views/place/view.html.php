...
class AllEventsViewPlace extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->richsnippetsblock = $dispatcher->trigger('onAlleventsRichSnippetsPlace', [&$this->item, &$this->params]);
    ...
    /**
     * AllEventsViewPlace::_prepareDocument()
     *
     * @throws Exception
     */
    protected function _prepareDocument()
    {
        ...
        if (($this->item) && ($this->item->metadesc)) {
