...
<?php if ($this->item) : ?>
    ...
    <div class="event_container">
        <div class="eml_event_content se_section_<?php echo $this->item->id; ?>_summary">
            ...
            <div id="allevents_list">
                <a href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&format=feed&s=' . $this->item->id . '&Itemid=' . $Itemid, false); ?>">
                    <i class="fa fa-rss"></i>
                </a>
                <?php
