...
?>
    ...
    <div id="allevents_agendas" class="items">
        <?php $show = false; ?>
                ...
                <div class="allevents_box_heading">
                    <h3 class="allevents_box_h3">
                        <a title="<?php echo $item->titre; ?>"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&at=' . json_encode($at)); ?>"><?php echo $item->titre; ?>
                            <small>
                        ...
                        <a target="_blank"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&format=feed&pivot=1&period=3&sort_by=0&at=' . json_encode($at) . '&Itemid=' . $Itemid); ?>">
                            <i class="fa fa-rss"
                               title="<?php echo JText::_('COM_ALLEVENTS_RSS_SUBSCRIBE'); ?>"></i>
                        </a>
                        <a
                            href="<?php echo JRoute::_('index.php?option=com_allevents&task=agenda.export&id=' . $item->id); ?>">
                ...
                <div class="allevents_box_content" style="display:flex;">
                    <div class="img-left hide-s">
                        <a title="<?php echo $item->titre; ?>" class="event-image"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&a=' . $item->id); ?>">
                            <?php
