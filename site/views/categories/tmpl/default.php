...
?>
    ...
    <div id="allevents_categories" class="items">
        <?php $show = false; ?>
                ...
                <div class="allevents_box_heading">
                    <h3 class="allevents_box_h3">
                        <a title="<?php echo $item->titre; ?>"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&ct=' . json_encode($ct)); ?>"><?php echo $item->titre; ?>
                            <small>
                        ...
                        <a target="_blank"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&format=feed&pivot=1&period=3&sort_by=0&ct=' . json_encode($ct) . '&Itemid=' . $Itemid); ?>">
                ...
                <div class="allevents_box_content" style="display:flex;">
                    <div class="img-left hide-s">
                        <a title="<?php echo $item->titre; ?>" class="event-image"
                           href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&c=' . $item->id); ?>">
                            <?php
...
<?php endif; ?>
<?php
echo AllEventsHelperInfiniteScroll::GetInfiniteScroll('#allevents_categories', '.allevents_box', true);
