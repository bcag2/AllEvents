...
$Itemid = 0; //(int) $app->input->getInt('Itemid', null);
?>
    <h1><?php echo $this->params['page_title']; ?></h1>
    <div id="allevents_venues" class="items">
        <?php $show = false;
        if (!empty($this->items)) {
                    ...
                    <div class="allevents_box_heading">
                        <h3 class="allevents_box_h3">
                            <a title="<?php echo $item->titre; ?>"
                               href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&l=' . $item->id, false); ?>"><?php echo $item->titre; ?>
                                <small>
                            ...
                            <a target="_blank"
                               href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&format=feed&l=' . $item->id . '&Itemid=' . $Itemid, false); ?>">
                    ...
                    <div class="allevents_box_content" style="display:flex;">
                        <div class="img-left hide-s">
                            <a title="<?php echo $item->titre; ?>" class="event-image"
                               href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&l=' . $item->id, false); ?>">
                                <?php
...
<?php endif; ?>
<?php
// echo AllEventsHelperInfiniteScroll::GetInfiniteScroll('#allevents_venues', '.allevents_box', true);
