...
<?php if ($this->item) : ?>
    ...
    <div class="event_container">
        <div class="eml_event_content se_activity_<?php echo $this->item->id; ?>_summary">
            ...
            <div id="allevents_list">
                <a href="<?php echo JRoute::_('index.php?option=com_allevents&view=events&format=feed&p=' . $this->item->id . '&Itemid=' . $Itemid, false); ?>">
                    <i class="fa fa-rss"></i>
                </a>
                <?php
                echo "<a href='" . JRoute::_('index.php?option=com_allevents&view=events&p=' . $this->item->id, false) . "'>" . JText::_('EVENTS_LIST') . "</a>";
                ?>
            </div>
        </div>
    </div>
