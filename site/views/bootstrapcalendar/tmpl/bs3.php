...
$document->addStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/css/bootstrap.min.css');
$document->addStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/css/bootstrap-theme.min.css');
...
$document->addScript('https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js');
$document->addScript(AllEventsHelperOverride::GetScript('underscore-min.js'));
$document->addScript('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/js/bootstrap.min.js');
        ...
        <div class="page-header">
            <div class="pull-right form-inline">
                <div class="btn-group">
                    ...
                    <?php endif; ?>
                    <button class="btn btn-default" data-calendar-nav="today"><?php echo JText::_('TODAY'); ?></button>
