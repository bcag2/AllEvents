 ...
 * @access    public
 */
class AllEventsModelRessource extends JModelItem
{
    /**
     * AllEventsModelRessource::getData()
     *
     * @param mixed $id
     *
    ...
    /**
     * AllEventsModelRessource::checkIn()
     *
     * @param mixed $id
     *
     * @return bool
    ...
    {
        // Get the id.
        $id = (!empty($id)) ? $id : (int)$this->getState('ressource.id');
    ...
    /**
     * AllEventsModelRessource::checkOut()
     *
     * @param mixed $id
     *
     * @return bool
    ...
    /**
     * AllEventsModelRessource::getCategoryName()
     *
     * @param mixed $id
     *
     * @return mixed
    ...
    /**
     * AllEventsModelRessource::publish()
     *
     * @param mixed $id
     * @param mixed $state
     *
    ...
    /**
     * AllEventsModelRessource::delete()
     *
     * @param mixed $id
     *
     * @return bool
    ...
    /**
     * AllEventsModelRessource::populateState()
     *
     * @throws Exception
     */
