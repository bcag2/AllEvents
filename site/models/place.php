 ...
 * @access    public
 */
class AllEventsModelPlace extends JModelItem
{
    /**
     * AllEventsModelPlace::getData()
     *
     * @param mixed $id
     *
    ...
    public function &getData($id = null)
    {
        ...
        $this->_item->link = JRoute::_('index.php?option=com_allevents&view=place&id=' . $this->_item->id . ':' . $this->_item->alias, false);
    ...
    /**
     * AllEventsModelPlace::getCategoryName()
     *
     * @param mixed $id
     *
     * @return mixed
