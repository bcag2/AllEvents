 ...
 * @access    public
 */
class AllEventsModelActivity extends JModelItem
{
    /**
     * AllEventsModelActivity::getData()
     *
     * @param mixed $id
     *
    ...
    /**
     * AllEventsModelActivity::checkIn()
     *
     * @param mixed $id
     *
     * @return bool
    ...
    {
        // Get the id.
        $id = (!empty($id)) ? $id : (int)$this->getState('activity.id');
    ...
    /**
     * AllEventsModelActivity::checkOut()
     *
     * @param mixed $id
     *
     * @return bool
    ...
    /**
     * AllEventsModelActivity::getCategoryName()
     *
     * @param mixed $id
     *
     * @return mixed
    ...
    /**
     * AllEventsModelActivity::publish()
     *
     * @param mixed $id
     * @param mixed $state
     *
    ...
    /**
     * AllEventsModelActivity::populateState()
     *
     * @throws Exception
     */
