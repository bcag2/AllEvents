...
$document->addStyleSheet(AllEventsHelperOverride::GetStyleSheet('jquery.calendario.transparent.css'));
?>
<div id="mod_aecalendar3" class="custom-calendar-wrap <?php echo $moduleclass_sfx; ?>">
