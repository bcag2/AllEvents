...
$document->addStyleSheet(AllEventsHelperOverride::GetStyleSheet('mod_aecalendar7.css'));
...
<div id="mod_aecalendar7" class="<?php echo $moduleclass_sfx; ?>"></div>