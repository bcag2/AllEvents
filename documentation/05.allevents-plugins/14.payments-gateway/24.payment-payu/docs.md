...
3. Go to **Extensions >> Plugin**, find and click on **Payment - PayU**. Then enable it.
...
| ------ | ----------- | ---- | ----- |
|  Plugin Name |  | text | (default:`Payu Credit Card/Debit Card/Net Banking`)|
|  Enter PayU MerchantID | Enter Merchant ID provided by PayU | text | |
|  SALT | SALT provided by PayU | text | |
|  Sandbox mode | Enable sandbox mode | radio | `No`, `Yes`|
