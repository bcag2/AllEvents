---
title: 'Payment - EasySocial Points'
date: '03:39 27-11-2017'
taxonomy:
    category:
        - Plugin
---
...
## Description
EasySocial Points Payments plugin for Common Payments Gateway by Techjoomla.

## Install the plugin
1. Download the extension to your local machine as a zip file package.
2. From the backend of your Joomla site (administration) select **Extensions >> Manager**, then Click the <b>Browse</b> button and select the extension package on your local machine. Then click the **Upload & Install** button to install module.
3. Go to **Extensions >> Plugin**, find and click on **Payment - EasySocial Points**. Then enable it.
...
| ------ | ----------- | ---- | ----- |
|  Conversion Amount | Conversion of one currency unit into EasySocial Points | text | (default:`10`)|
|  points |  | hidden | (default:`point`)|
|  Plugin Name | Plugin Name | text | (default:`EasySocial Points`)|
