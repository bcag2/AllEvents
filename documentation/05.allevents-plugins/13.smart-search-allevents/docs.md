...
Enables Indexing for Smart Search of the AllEvents events.
...
3. Go to **Extensions >> Plugin**, find and click on **Smart Search - AllEvents**. Then enable it.
