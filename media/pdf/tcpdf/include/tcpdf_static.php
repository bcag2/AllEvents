...
class TCPDF_STATIC
{
    ...
    public static function getPageSizeFromFormat($format)
    {
        ...
        switch (strtoupper($format)) {
            ...
            case 'A0' : {
                $pf = [2383.937, 3370.394];
                break;
            }
            case 'A1' : {
                $pf = [1683.780, 2383.937];
                break;
            }
            case 'A2' : {
                $pf = [1190.551, 1683.780];
                break;
            }
            case 'A3' : {
                $pf = [841.890, 1190.551];
            ...
            case 'B0' : {
                $pf = [2834.646, 4008.189];
                break;
            }
            case 'B1' : {
                $pf = [2004.094, 2834.646];
                break;
            }
            case 'B2' : {
                $pf = [1417.323, 2004.094];
                break;
            }
            case 'B3' : {
                $pf = [1000.630, 1417.323];
                break;
            }
            case 'B4' : {
                $pf = [708.661, 1000.630];
            ...
            case 'C0' : {
                $pf = [2599.370, 3676.535];
                break;
            }
            case 'C1' : {
                $pf = [1836.850, 2599.370];
                break;
            }
            case 'C2' : {
                $pf = [1298.268, 1836.850];
                break;
            }
            case 'C3' : {
                $pf = [918.425, 1298.268];
            ...
            // SIS 014711 E Series
            case 'E0' : {
                $pf = [2491.654, 3517.795];
                break;
            }
            case 'E1' : {
                $pf = [1757.480, 2491.654];
                break;
            }
            case 'E2' : {
                $pf = [1247.244, 1757.480];
                break;
            }
            case 'E3' : {
                $pf = [878.740, 1247.244];
            ...
            // SIS 014711 G Series
            case 'G0' : {
                $pf = [2715.591, 3838.110];
                break;
            }
            case 'G1' : {
                $pf = [1919.055, 2715.591];
                break;
            }
            case 'G2' : {
                $pf = [1357.795, 1919.055];
                break;
            }
            case 'G3' : {
                $pf = [958.110, 1357.795];
            ...
            // ISO Press
            case 'RA0': {
                $pf = [2437.795, 3458.268];
                break;
            }
            case 'RA1': {
                $pf = [1729.134, 2437.795];
                break;
            }
            case 'RA2': {
                $pf = [1218.898, 1729.134];
                break;
            }
            case 'RA3': {
                $pf = [864.567, 1218.898];
            ...
            case 'SRA0': {
                $pf = [2551.181, 3628.346];
                break;
            }
            case 'SRA1': {
                $pf = [1814.173, 2551.181];
                break;
            }
            case 'SRA2': {
                $pf = [1275.591, 1814.173];
                break;
            }
            case 'SRA3': {
                $pf = [907.087, 1275.591];
            ...
            // German  DIN 476
            case '4A0': {
                $pf = [4767.874, 6740.787];
                break;
            }
            case '2A0': {
                $pf = [3370.394, 4767.874];
                break;
            }
            // Variations on the ISO Standard
            case 'A2_EXTRA'   : {
                $pf = [1261.417, 1754.646];
                break;
            }
            case 'A3+'        : {
                $pf = [932.598, 1369.134];
            ...
            // ANSI Series
            case 'ANSI_E': {
                $pf = [2448.000, 3168.000];
                break;
            }
            case 'ANSI_D': {
                $pf = [1584.000, 2448.000];
                break;
            }
            case 'ANSI_C': {
                $pf = [1224.000, 1584.000];
                break;
            }
            case 'ANSI_B': {
                $pf = [792.000, 1224.000];
            ...
            case 'P1': {
                $pf = [1587.402, 2437.795];
                break;
            }
            case 'P2': {
                $pf = [1218.898, 1587.402];
                break;
            }
            case 'P3': {
                $pf = [793.701, 1218.898];
            ...
            case 'ARCH_E' : {
                $pf = [2592.000, 3456.000];
                break;
            }
            case 'ARCH_E1': {
                $pf = [2160.000, 3024.000];
                break;
            }
            case 'ARCH_D' : {
                $pf = [1728.000, 2592.000];
                break;
            }
            case 'BROADSHEET':
            case 'ARCH_C' : {
                $pf = [1296.000, 1728.000];
                break;
            }
            case 'ARCH_B' : {
                $pf = [864.000, 1296.000];
            ...
            case 'JIS_B0' : {
                $pf = [2919.685, 4127.244];
                break;
            }
            case 'JIS_B1' : {
                $pf = [2063.622, 2919.685];
                break;
            }
            case 'JIS_B2' : {
                $pf = [1459.843, 2063.622];
                break;
            }
            case 'JIS_B3' : {
                $pf = [1031.811, 1459.843];
                break;
            }
            case 'JIS_B4' : {
                $pf = [728.504, 1031.811];
            ...
            // PA Series
            case 'PA0' : {
                $pf = [2381.102, 3174.803,];
                break;
            }
            case 'PA1' : {
                $pf = [1587.402, 2381.102];
                break;
            }
            case 'PA2' : {
                $pf = [1190.551, 1587.402];
                break;
            }
            case 'PA3' : {
                $pf = [793.701, 1190.551];
            ...
            // Billboards
            case '4SHEET' : {
                $pf = [2880.000, 4320.000];
                break;
            }
            case '6SHEET' : {
                $pf = [3401.575, 5102.362];
                break;
            }
            case '12SHEET': {
                $pf = [8640.000, 4320.000];
                break;
            }
            case '16SHEET': {
                $pf = [5760.000, 8640.000];
                break;
            }
            case '32SHEET': {
                $pf = [11520.000, 8640.000];
                break;
            }
            case '48SHEET': {
                $pf = [17280.000, 8640.000];
                break;
            }
            case '64SHEET': {
                $pf = [23040.000, 8640.000];
                break;
            }
            case '96SHEET': {
                $pf = [34560.000, 8640.000];
                break;
            }
            // Old European Sizes
            //   - Old Imperial English Sizes
            case 'EN_EMPEROR'          : {
                $pf = [3456.000, 5184.000];
                break;
            }
            case 'EN_ANTIQUARIAN'      : {
                $pf = [2232.000, 3816.000];
                break;
            }
            case 'EN_GRAND_EAGLE'      : {
                $pf = [2070.000, 3024.000];
                break;
            }
            case 'EN_DOUBLE_ELEPHANT'  : {
                $pf = [1926.000, 2880.000];
                break;
            }
            case 'EN_ATLAS'            : {
                $pf = [1872.000, 2448.000];
                break;
            }
            case 'EN_COLOMBIER'        : {
                $pf = [1692.000, 2484.000];
                break;
            }
            case 'EN_ELEPHANT'         : {
                $pf = [1656.000, 2016.000];
                break;
            }
            case 'EN_DOUBLE_DEMY'      : {
                $pf = [1620.000, 2556.000];
                break;
            }
            case 'EN_IMPERIAL'         : {
                $pf = [1584.000, 2160.000];
                break;
            }
            case 'EN_PRINCESS'         : {
                $pf = [1548.000, 2016.000];
                break;
            }
            case 'EN_CARTRIDGE'        : {
                $pf = [1512.000, 1872.000];
                break;
            }
            case 'EN_DOUBLE_LARGE_POST': {
                $pf = [1512.000, 2376.000];
                break;
            }
            case 'EN_ROYAL'            : {
                $pf = [1440.000, 1800.000];
                break;
            }
            case 'EN_SHEET':
            case 'EN_HALF_POST'        : {
                $pf = [1404.000, 1692.000];
                break;
            }
            case 'EN_SUPER_ROYAL'      : {
                $pf = [1368.000, 1944.000];
                break;
            }
            case 'EN_DOUBLE_POST'      : {
                $pf = [1368.000, 2196.000];
                break;
            }
            case 'EN_MEDIUM'           : {
                $pf = [1260.000, 1656.000];
                break;
            }
            case 'EN_DEMY'             : {
                $pf = [1260.000, 1620.000];
                break;
            }
            case 'EN_LARGE_POST'       : {
                $pf = [1188.000, 1512.000];
                break;
            }
            case 'EN_COPY_DRAUGHT'     : {
                $pf = [1152.000, 1440.000];
                break;
            }
            case 'EN_POST'             : {
                $pf = [1116.000, 1386.000];
                break;
            }
            case 'EN_CROWN'            : {
                $pf = [1080.000, 1440.000];
                break;
            }
            case 'EN_PINCHED_POST'     : {
                $pf = [1062.000, 1332.000];
                break;
            }
            case 'EN_BRIEF'            : {
                $pf = [972.000, 1152.000];
            ...
            case 'BE_GRAND_AIGLE' : {
                $pf = [1984.252, 2948.031];
                break;
            }
            case 'BE_COLOMBIER'   : {
                $pf = [1757.480, 2409.449];
                break;
            }
            case 'BE_DOUBLE_CARRE': {
                $pf = [1757.480, 2607.874];
                break;
            }
            case 'BE_ELEPHANT'    : {
                $pf = [1746.142, 2182.677];
                break;
            }
            case 'BE_PETIT_AIGLE' : {
                $pf = [1700.787, 2381.102];
                break;
            }
            case 'BE_GRAND_JESUS' : {
                $pf = [1559.055, 2069.291];
                break;
            }
            case 'BE_JESUS'       : {
                $pf = [1530.709, 2069.291];
                break;
            }
            case 'BE_RAISIN'      : {
                $pf = [1417.323, 1842.520];
                break;
            }
            case 'BE_GRAND_MEDIAN': {
                $pf = [1303.937, 1714.961];
                break;
            }
            case 'BE_DOUBLE_POSTE': {
                $pf = [1233.071, 1601.575];
                break;
            }
            case 'BE_COQUILLE'    : {
                $pf = [1218.898, 1587.402];
            ...
            case 'BE_PETIT_MEDIAN': {
                $pf = [1176.378, 1502.362];
                break;
            }
            case 'BE_RUCHE'       : {
                $pf = [1020.472, 1303.937];
                break;
            }
            case 'BE_PROPATRIA'   : {
                $pf = [977.953, 1218.898];
            ...
            case 'FR_UNIVERS'          : {
                $pf = [2834.646, 3685.039];
                break;
            }
            case 'FR_DOUBLE_COLOMBIER' : {
                $pf = [2551.181, 3571.654];
                break;
            }
            ...
            case 'FR_DOUBLE_SOLEIL'    : {
                $pf = [2267.717, 3401.575];
                break;
            }
            case 'FR_DOUBLE_JESUS'     : {
                $pf = [2154.331, 3174.803];
                break;
            }
            case 'FR_GRAND_AIGLE'      : {
                $pf = [2125.984, 3004.724];
                break;
            }
            case 'FR_PETIT_AIGLE'      : {
                $pf = [1984.252, 2664.567];
                break;
            }
            case 'FR_DOUBLE_RAISIN'    : {
                $pf = [1842.520, 2834.646];
                break;
            }
            case 'FR_JOURNAL'          : {
                $pf = [1842.520, 2664.567];
                break;
            }
            case 'FR_COLOMBIER_AFFICHE': {
                $pf = [1785.827, 2551.181];
                break;
            }
            ...
            case 'FR_DOUBLE_CARRE'     : {
                $pf = [1587.402, 2551.181];
                break;
            }
            case 'FR_DOUBLE_COQUILLE'  : {
                $pf = [1587.402, 2494.488];
                break;
            }
            case 'FR_JESUS'            : {
                $pf = [1587.402, 2154.331];
                break;
            }
            case 'FR_RAISIN'           : {
                $pf = [1417.323, 1842.520];
            ...
            case 'FR_CAVALIER'         : {
                $pf = [1303.937, 1757.480];
                break;
            }
            case 'FR_DOUBLE_COURONNE'  : {
                $pf = [1303.937, 2040.945];
                break;
            }
            case 'FR_CARRE'            : {
                $pf = [1275.591, 1587.402];
                break;
            }
            case 'FR_COQUILLE'         : {
                $pf = [1247.244, 1587.402];
                break;
            }
            case 'FR_DOUBLE_TELLIERE'  : {
                $pf = [1247.244, 1927.559];
                break;
            }
            case 'FR_DOUBLE_CLOCHE'    : {
                $pf = [1133.858, 1700.787];
                break;
            }
            case 'FR_DOUBLE_POT'       : {
                $pf = [1133.858, 1757.480];
                break;
            }
            case 'FR_ECU'              : {
                $pf = [1133.858, 1474.016];
                break;
            }
            case 'FR_COURONNE'         : {
                $pf = [1020.472, 1303.937];
     ...
     *
     * @param string $layout (string) The page layout. Possible values are:<ul><li>SinglePage Display one page at a time</li><li>OneColumn Display the pages in one column</li><li>TwoColumnLeft Display the pages in two columns, with odd-numbered pages on the left</li><li>TwoColumnRight Display the pages in two columns, with odd-numbered pages on the right</li><li>TwoPageLeft (PDF 1.5) Display the pages two at a time, with odd-numbered pages on the left</li><li>TwoPageRight (PDF 1.5) Display the pages two at a time, with odd-numbered pages on the right</li></ul>
     *
     * @return string (string) Canonical page layout name.
     * @public static
     */
     ...
     * Get the canonical page layout mode.
     *
     * @param string $mode (string) A name object specifying how the document should be displayed when opened:<ul><li>UseNone Neither document outline nor thumbnail images visible</li><li>UseOutlines Document outline visible</li><li>UseThumbs Thumbnail images visible</li><li>FullScreen Full-screen mode, with no menu bar, window controls, or any other window visible</li><li>UseOC (PDF 1.5) Optional content group panel visible</li><li>UseAttachments (PDF 1.6) Attachments panel visible</li></ul>
     *
     * @return string (string) Canonical page mode name.
     * @public static
     */
     ...
     *
     * @return string (string) Encoded name object.
     * @author Nicola Asuni
