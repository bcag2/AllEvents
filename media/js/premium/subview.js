(function ($) {
    ...
    var show_functions = [],
        ...
        screenPosition,
        $this,
        subviewShowClass = ".show-sv",
        subviewHideClass = ".hide-sv",
        subviewBackClass = ".back-sv",
        subview_action = "",
    ...
    $(subviewShowClass).on("click", function (e) {
        var customOptions = {};
        customOptions.content = $(this).attr('href');
        customOptions.startFrom = $(this).data("startfrom");
        customOptions.onShow = $(this).data("onshow");
        customOptions.onHide = $(this).data("onhide");
        customOptions.onClose = $(this).data("onclose");
