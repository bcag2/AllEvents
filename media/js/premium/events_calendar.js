var isIE8 = false,
    isIE9 = false,
    inner = jQuery(".main-wrapper > .inner"),
    supportTransition = true,
    closedbar = jQuery(".closedbar"),
    isMobile = false,
//isIEMobile = false,
    $body = jQuery("body"),
    $windowWidth, $windowHeight, subViews = jQuery(".subviews"),
    sideLeft = jQuery('#pageslide-left'),
    sideRight = jQuery('#pageslide-right'),
    ...
    footer = jQuery(".main-wrapper > footer");
var //thisSlider, actualItemWidth, newItemWidth,
...
var Main = function ($) {
    ...
    var runSaveSetting = function () {
        $('.save_style').on('click', function () {
            ...
            espressoSetting.headerDefault = !!$body.hasClass('header-default');
            espressoSetting.footerDefault = !$body.hasClass('footer-fixed');
            espressoSetting.slideDefault = !!sideLeft.hasClass('slide-default');
