 ...
 * @since  1.6
 */
class AlleventsControllerFields extends JControllerAdmin
{
    /**
     * Method to clone existing Fields
     *
     * @return void
     * @throws Exception
     */
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_allevents&view=fields');
    }
     ...
     * @since    1.6
     */
    public function getModel($name = 'field', $prefix = 'AlleventsModel', $config = [])
    {
