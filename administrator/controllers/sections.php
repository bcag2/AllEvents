 ...
 * @access    public
 */
class AllEventsControllerSections extends JControllerAdmin
{
    /**
     * AllEventsControllerSections::saveOrderAjax()
     *
     * @throws Exception
     */
    ...
    /**
     * AllEventsControllerSections::getModel()
     *
     * @param string $name
     * @param string $prefix
     * @param array $config
     ...
     * @return object
     */
    public function getModel($name = 'section', $prefix = 'AllEventsModel', $config = [])
    {
    ...
    /**
     * AllEventsControllerSections::duplicate()
     *
     */
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_allevents&view=sections');
    }

    /**
     * AllEventsControllerEvent::GetSectionsFromAgenda()
     *
     * @return bool
     * @throws Exception
     */
    public function GetSectionsFromAgenda()
    {
        ...
        if (JFactory::getApplication()->input->get('ajax', 0) != 0) {
            ...
            $table = $model->GetSectionsFromAgenda(JFactory::getApplication()->input->getInt('agenda_id'));
