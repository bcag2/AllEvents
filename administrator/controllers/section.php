 ...
 * @access    public
 */
class AllEventsControllerSection extends JControllerForm
{
    /**
     * AllEventsControllerSection::__construct()
     */
    ...
    /**
     * AllEventsControllerSection::save()
     *
     * @param mixed $key
     * @param mixed $urlVar
     *
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        $query->select('max(id)')->from($db->quoteName('#__allevents_sections'));
    ...
    /**
     * AllEventsControllerSection::unfeatured()
     *
     * @throws Exception
     */
    public function unfeatured()
    {
        ...
        $redirectTo = JRoute::_('index.php?option=com_allevents&view=sections&task=display', false);
        $this->setRedirect($redirectTo);
    }

    /**
     * AllEventsControllerSection::featured()
     *
     * @throws Exception
     */
