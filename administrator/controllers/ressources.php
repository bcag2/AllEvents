 ...
 * @access    public
 */
class AllEventsControllerRessources extends JControllerAdmin
{
    /**
     * AllEventsControllerRessources::saveOrderAjax()
     *
     * @throws Exception
     */
    ...
    /**
     * AllEventsControllerRessources::getModel()
     *
     * @param string $name
     * @param string $prefix
     * @param array $config
     ...
     * @return object
     */
    public function getModel($name = 'ressource', $prefix = 'AllEventsModel', $config = [])
    {
    ...
    /**
     * AllEventsControllerRessources::duplicate()
     *
     */
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_allevents&view=ressources');
    }

    /**
     * AllEventsControllerEvent::GetRessourcesFromAgenda()
     *
     * @return bool
     * @throws Exception
     */
    public function GetRessourcesFromAgenda()
    {
        ...
        if (JFactory::getApplication()->input->get('ajax', 0) != 0) {
            $model = $this->getModel('Ressources');
            $table = $model->GetRessourcesFromAgenda(JFactory::getApplication()->input->getInt('agenda_id'));
