 ...
 * @access    public
 */
class AllEventsControllerCategory extends JControllerForm
{
    /**
     * AllEventsControllerCategory::__construct()
     */
    ...
    /**
     * AllEventsControllerCategory::save()
     *
     * @param mixed $key
     * @param mixed $urlVar
     *
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        $query->select('max(id)')->from($db->quoteName('#__allevents_categories'));
    ...
    /**
     * AllEventsControllerCategory::unfeatured()
     *
     * @throws Exception
     */
    public function unfeatured()
    {
        ...
        $redirectTo = JRoute::_('index.php?option=com_allevents&view=categories&task=display', false);
        $this->setRedirect($redirectTo);
    }

    /**
     * AllEventsControllerCategory::featured()
     *
     * @throws Exception
     */
