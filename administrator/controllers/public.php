 ...
 * @access    public
 */
class AllEventsControllerPublic extends JControllerForm
{
    /**
     * AllEventsControllerPublic::__construct()
     */
    function __construct()
    {
        $this->view_list = 'publics';
        parent::__construct();
    }

    /**
     * AllEventsControllerPublic::save()
     *
     * @param mixed $key
     * @param mixed $urlVar
     *
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        $query->select('max(id)')->from($db->quoteName('#__allevents_public'));
    ...
    /**
     * AllEventsControllerPublic::unfeatured()
     *
     * @throws Exception
     */
    public function unfeatured()
    {
        ...
        $redirectTo = JRoute::_('index.php?option=com_allevents&view=publics&task=display', false);
        $this->setRedirect($redirectTo);
    }

    /**
     * AllEventsControllerPublic::featured()
     *
     * @throws Exception
     */
