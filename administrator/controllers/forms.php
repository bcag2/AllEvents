 ...
 * @since  1.6
 */
class AlleventsControllerForms extends JControllerAdmin
{
    /**
     * Method to clone existing Forms
     *
     * @return void
     * @throws Exception
     */
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_allevents&view=forms');
    }
     ...
     * @since    1.6
     */
    public function getModel($name = 'form', $prefix = 'AlleventsModel', $config = [])
    {
