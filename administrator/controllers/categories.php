 ...
 * @access    public
 */
class AllEventsControllerCategories extends JControllerAdmin
{
    /**
     * @throws Exception
     */
     ...
     * @return object
     */
    public function getModel($name = 'category', $prefix = 'AllEventsModel', $config = [])
    {
    ...
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_allevents&view=categories');
    }

    /**
     * AllEventsControllerEvent::GetCategoriesFromSection()
     *
     * @return bool
     * @throws Exception
     */
    public function GetCategoriesFromSection()
    {
        ...
        if (JFactory::getApplication()->input->get('ajax', 0) != 0) {
            $model = $this->getModel();
            $table = $model->GetCategoriesFromSection(JFactory::getApplication()->input->getInt('section_id'));
