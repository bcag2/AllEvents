...
/**
 * JFormRuleAEJContactAddressFormat
 *
 * @version   %%ae3.version%%
 * @package   %%ae3.package%%
...
/**
 * Check Joomla Contact address format
 */
class JFormRuleAEJContactAddressFormat extends JFormRule
{
    /**
    ...
    public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
    {
        ...
        $showjcontacts_field_name = $field_name = (empty($group) ? '' : $group . '.') . 'controlpanel_showjcontacts';
        if ($component_enabled && $input->get($showjcontacts_field_name)) {
