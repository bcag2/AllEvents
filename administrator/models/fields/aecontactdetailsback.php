<?php
/**
 * JFormFieldAEContactDetailsBack
 *
 * @version   %%ae3.version%%
 * @package   %%ae3.package%%
...
// JLoader::register('JFormFieldModal_Contact', JPATH_ADMINISTRATOR . '/components/com_contact/models/fields/modal/contact.php');

/**
 * Simply reuse JFormFieldModal_Contact from mod_contact
 */
class JFormFieldAEContactDetailsBack extends JFormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!$this->element['condensed']) $str .= JText::_('JSELECT');
        ...
        if ($allowEdit) {
            ...
            if (!$this->element['condensed']) $str .= JText::_('JACTION_EDIT');
        ...
        if ($allowClear) {
            ...
            if (!$this->element['condensed']) $str .= JText::_('JCLEAR');
