...
{
    /**
     * JHtmlEnrolment::enable_enrolment()
     *
     * @param int $value
     * @param int $i
     *
     * @return string
     */
    static function enable_enrolment($value = 0, $i)
    {
        $states = [
            0 => [
                '',
                'enrolments.enable_enrolment',
                '',
                '',
