...
class AllEventsClassMD
{
    ...
    public static function MakeMDObject($extension = "com_allevents", $object = "event")
    {
        ...
        fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
        $sLine = '![](https://img.shields.io/badge/AllEvents-v3.5-blue.svg) &nbsp; ![](https://img.shields.io/badge/licence-GNU--GPL-green.svg)<br/><br/>';
        fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
    ...
    public static function MakeMD($extension, $path, $subpath = "")
    {
        ...
        if (!empty($filename)) {
            ...
            if ($path == 'modules') {
                ...
                fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
                $sLine = 'The module is bundled in the AllEvents installation package and available in Joomla\'s Module Manager after installing AllEvents.';
                fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
            } elseif ($path == 'plugins') {
            ...
            if ($path == 'modules') {
                ...
                $sLine = 'Once you have created a new AllEvents module, you can quickly gain access to its customization options by visiting `Administrator -> Extensions -> Module Manager` and selecting your AllEvents module.';
                fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
                $sLine = 'Creating a new module is a simple process, as well. You just navigate to the **Module Manager** and select **New** on the toolbar in the upper-left area of the page.';
                fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
                $sLine = 'Below, we have outlined the options available to you as you configure your AllEvents module : ';
                fwrite($handle, $sLine . PHP_EOL . PHP_EOL);
            } elseif ($path == 'plugins') {
