...
class When extends \DateTime
{
     ...
     *
     * @param string $time
     * @param null|DateTimeZone|null $timezone
     */
                ...
                if ($this->freq === "monthly") {
                    ...
                    if ($this->freq === "weekly") {
                        ...
                        if ($count === 0) {
                            ...
                            $daysLeft = 1 + (int)$dateLooper->diff($startWeekDay)->format("%a");
...
class InvalidCombination extends \Exception
{
     ...
     */
    /**
     * InvalidCombination constructor.
     *
