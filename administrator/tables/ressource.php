 ...
 * @access    public
 */
class AllEventsTableressource extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_ressources', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='ressource']/");
            $default_actions = JAccess::getAssetRules('com_allevents.ressource.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.ressource.' . (int)$this->$k;
    }
