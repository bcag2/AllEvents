 ...
 * @access    public
 */
class AllEventsTablelink extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_links', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='link']/");

            $default_actions = JAccess::getAssetRules('com_allevents.link.' . $array['id'])->getData();
            $array_jaccess = [];
...
// If checkIn is supported and all rows were adjusted, check them in.
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.link.' . (int)$this->$k;
    }
