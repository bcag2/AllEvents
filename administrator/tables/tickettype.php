 ...
 * @access    public
 */
class AllEventsTableTickettype extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_Tickettypes', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (isset($array['event_id'])) {
            ...
            } elseif (strrpos($array['event_id'], ',') != false) {
                $array['event_id'] = explode(',', $array['event_id']);
            } elseif (empty($array['event_id'])) {
                $array['event_id'] = '';
            }
        }
        $input = $app->input;
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='Tickettype']/");
            $default_actions = JAccess::getAssetRules('com_allevents.Tickettype.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.Tickettype.' . (int)$this->$k;
    }
