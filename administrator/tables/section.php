 ...
 * @access    public
 */
class AllEventsTablesection extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_sections', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='section']/");
            $default_actions = JAccess::getAssetRules('com_allevents.section.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.section.' . (int)$this->$k;
    }
