 ...
 * @access    public
 */
class AllEventsTableenrolment extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_enrolments', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (isset($array['event_id'])) {
            if (is_array($array['event_id'])) {
                $array['event_id'] = implode(',', $array['event_id']);
            } else
                if (strrpos($array['event_id'], ',') != false) {
                    $array['event_id'] = explode(',', $array['event_id']);
                } else
                    if (empty($array['event_id'])) {
                        $array['event_id'] = '';
                    }
        }
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='enrolment']/");

            $default_actions = JAccess::getAssetRules('com_allevents.enrolment.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.enrolment.' . (int)$this->$k;
    }
