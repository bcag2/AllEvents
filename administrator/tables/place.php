 ...
 * @access    public
 */
class AllEventsTableplace extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_places', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='place']/");
            $default_actions = JAccess::getAssetRules('com_allevents.place.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.place.' . (int)$this->$k;
    }
