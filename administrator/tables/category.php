 ...
 * @access    public
 */
class AllEventsTablecategory extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__allevents_categories', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
            $actions = JAccess::getActionsFromFile(JPATH_SITE . '/administrator/components/com_allevents/access.xml', "/access/section[@name='category']/");
            $default_actions = JAccess::getAssetRules('com_allevents.category.' . $array['id'])->getData();
            $array_jaccess = [];
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_allevents.category.' . (int)$this->$k;
    }
