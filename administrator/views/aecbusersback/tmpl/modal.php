...
$function = 'jSelectAECBUser_' . $field;
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn = $this->escape($this->state->get('list.direction'));
?>
<form
    action="<?php echo JRoute::_('index.php?option=com_allevents&view=aecbusersback&layout=modal&tmpl=component&groups=' . $input->get('groups', '', 'BASE64') . '&excluded=' . $input->get('excluded', '', 'BASE64')); ?>"
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
                ...
                <input type="text" name="filter_search" id="filter_search"
                       ...
                       title="<?php echo JHtml::tooltipText('COM_ALLEVENTS_SEARCH_CBUSERS'); ?>"
            ...
            <div class="btn-group pull-right hidden-phone">
                <label for="filter_group_id"
                       class="element-invisible"><?php echo JText::_('COM_ALLEVENTS_USERGROUP'); ?></label>
        ...
        <table class="table table-striped table-condensed">
            ...
            <tr>
                <th class="left" width="25%">
                    <?php echo JHtml::_('grid.sort', 'COM_ALLEVENTS_USERNAME', 'ju.name', $listDirn, $listOrder); ?>
                </th>
                <th class="nowrap" width="25%">
                    <?php echo JHtml::_('grid.sort', 'JGLOBAL_USERNAME', 'ju.username', $listDirn, $listOrder); ?>
                </th>
                <th class="nowrap" width="25%">
                    <?php echo JHtml::_('grid.sort', 'JGLOBAL_EMAIL', 'ju.email', $listDirn, $listOrder); ?>
                </th>
                <th class="nowrap" width="10%">
                    <?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'cbu.id', $listDirn, $listOrder); ?>
                </th>
                <th class="nowrap" width="25%">
                    <?php echo JText::_('COM_ALLEVENTS_USERGROUP'); ?>
                </th>
            </tr>
            </thead>
            <tfoot>
