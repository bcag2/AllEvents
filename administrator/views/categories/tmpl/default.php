...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=categories', false); ?>" method="post"
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=category.edit&id=' . (int)$item->id, false); ?>">
                        ...
                        <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <?php echo '<a rel="tooltip" data-original-title="' . JText::sprintf('COM_ALLEVENTS_FILTER', JText::_('CATEGORY')) . '" href="' . JRoute::_('index.php?option=com_allevents&view=events&filter_category=' . $item->id) . '"><i class="icon-share-alt hide-icon"></i></a>'; ?>
                                </div>
                            </td>
                            <td>
                                <?php
                                $hot = empty($item->default) ? 0 : $item->default;
                                echo JHtml::_('aecategory.featured', $hot, $i);
                                ?>
                            </td>
