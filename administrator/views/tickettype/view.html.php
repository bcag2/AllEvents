 ...
 * @access    public
 */
class AllEventsViewTickettype extends JViewLegacy
{
    protected $state;
    protected $item;
    protected $form;
    ...
    /**
     * AllEventsViewTickettype::display()
     *
     * @param mixed $tpl
     *
     * @return mixed|void
    ...
    /**
     * AllEventsViewTickettype::addToolbar()
     *
     */
    protected function addToolbar()
    {
        ...
        if (isset($this->item) && !empty($this->item)) {
            ...
            if (!$checkedOut && ($canDo->get('core.create'))) {
                JToolbarHelper::custom('tickettype.save2same', 'save-new.png', 'save-new_f2.png', 'COM_ALLEVENTS_ENROLMENT_SAVE_AND_SAME', false);
