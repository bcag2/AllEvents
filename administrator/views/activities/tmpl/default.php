...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=activities', false); ?>" method="post"
                ...
                <table class="table table-striped" id="activityList">
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->published)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->published, $i, 'activities.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=activity.edit&id=' . (int)$item->id, false); ?>">
                        ...
                        <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <?php echo '<a rel="tooltip" data-original-title="' . JText::sprintf('COM_ALLEVENTS_FILTER', JText::_('ACTIVITY')) . '" href="' . JRoute::_('index.php?option=com_allevents&view=events&filter_activity=' . $item->id) . '"><i class="icon-share-alt hide-icon"></i></a>'; ?>
                                </div>
                            </td>
                            <td>
                                <?php
                                $hot = empty($item->default) ? 0 : $item->default;
                                echo JHtml::_('aeactivity.featured', $hot, $i);
