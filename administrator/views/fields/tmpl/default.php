...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_allevents&task=fields.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=fields'); ?>" method="post"
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=field.edit&id=' . (int)$item->id); ?>">
