...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=publics', false); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <?php else : ?>
                ...
                <table class="table table-striped" id="publicList">
                    <thead>
                    <tr>
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->published)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->published, $i, 'publics.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>

                            <td>
                                <?php if (isset($item->checked_out) && $item->checked_out) : ?>
                                    <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'publics.', $canCheckin); ?>
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=public.edit&id=' . (int)$item->id, false); ?>">
                        ...
                        <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <?php echo '<a rel="tooltip" data-original-title="' . JText::sprintf('COM_ALLEVENTS_FILTER', JText::_('PUBLIC')) . '" href="' . JRoute::_('index.php?option=com_allevents&view=events&filter_public=' . $item->id) . '"><i class="icon-share-alt hide-icon"></i></a>'; ?>
                                </div>
                            </td>
                            <td>
                                <?php
                                $hot = empty($item->default) ? 0 : $item->default;
                                echo JHtml::_('aepublic.featured', $hot, $i);
                                ?>
                            </td>
                            <td>
                                <div
