...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=sections', false); ?>" method="post"
                ...
                <table class="table table-striped" id="sectionList">
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->published)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->published, $i, 'sections.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=section.edit&id=' . (int)$item->id, false); ?>">
                        ...
                        <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <?php echo '<a rel="tooltip" data-original-title="' . JText::sprintf('COM_ALLEVENTS_FILTER', JText::_('SECTION')) . '" href="' . JRoute::_('index.php?option=com_allevents&view=events&filter_section=' . $item->id) . '"><i class="icon-share-alt hide-icon"></i></a>'; ?>
                                </div>
                            </td>
                            <td>
                                <?php
                                $hot = empty($item->default) ? 0 : $item->default;
                                echo JHtml::_('aesection.featured', $hot, $i);
                                ?>
                            </td>
                            <td>
                                <div
