...
class AllEventsViewSections extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        AllEventsHelper::addSubmenu('sections');
    ...
    /**
     * AllEventsViewSections::addToolbar()
     *
     */
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_ALLEVENTS_TITLE_SECTIONS'), 'folder-3');
        // Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_SITE . '/administrator/components/com_allevents/views/section';
        ...
        if ($canDo->get('core.create')) {
            JToolbarHelper::custom('sections.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
        }
        ...
        if ($canDo->get('core.edit')) {
            ...
            if ($this->state->get('filter.state') != -1) {
                if ($this->state->get('filter.state') != 2) {
                    ...
                    JToolbarHelper::unarchiveList('sections.publish');
                }
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_allevents&view=sections');

        $this->extra_sidebar = '';
    }

    /**
     * AllEventsViewSections::getSortFields()
     *
     * @return array
     */
