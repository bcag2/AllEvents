 ...
 * @access    public
 */
class AlleventsViewField extends JViewLegacy
{
    protected $state;
    protected $item;
    protected $form;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title($isNew ? 'AllEvents <span style="font-size:14px;">- ' . JText::_('COM_ALLEVENTS_LEGEND_NEW_FIELD') . '</span>' : 'AllEvents <span style="font-size:14px;">- ' . JText::_('COM_ALLEVENTS_LEGEND_EDIT_FIELD') . '</span>', $isNew ? 'new' : 'pencil-2');

        $aeTitle = $isNew ? JText::_('COM_ALLEVENTS_LEGEND_NEW_FIELD') : JText::_('COM_ALLEVENTS_LEGEND_EDIT_FIELD');
