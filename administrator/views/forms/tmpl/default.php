...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_allevents&task=forms.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=forms'); ?>" method="post"
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="formList">
                ...
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_ALLEVENTS_TEMPLATE', 'a.`template`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                     ...
                     <i class="icon-menu"></i>
                        ...
                        <?php if (isset($this->items[0]->state)): ?>
                            <td class="center">
                                ...
                                <div class="btn-group">
                                    <?php if ($canEdit): ?>
                                        <?php echo JDom::_('html.grid.task', [
                                            'commandAcl' => ['core.edit.own', 'core.edit'],
                                            'enabled' => ((bool)$canEdit),
                                            'label' => 'JTOOLBAR_EDIT',
                                            'num' => $i,
                                            'task' => 'form.edit'
                                        ]);

                                        echo JDom::_('html.grid.task', [
                                            'commandAcl' => 'core.edit.state',
                                            'dataKey' => 'published',
                                            'dataObject' => $item,
                                            'enabled' => ($item->state != 1),
                                            'label' => 'JTOOLBAR_PUBLISH',
                                            'num' => $i,
                                            'task' => 'forms.publish'
                                        ]);
                                        ...
                                        echo JDom::_('html.grid.task', [
                                            ...
                                            'dataKey' => 'published',
                                            'dataObject' => $item,
                                            'enabled' => ($item->state != 0),
                                            'label' => 'JTOOLBAR_UNPUBLISH',
                                            'num' => $i,
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=form.edit&id=' . (int)$item->id); ?>">
