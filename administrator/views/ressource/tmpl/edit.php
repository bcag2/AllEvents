...
<script type="text/javascript">
    ...
    Joomla.submitbutton = function (task) {
        if (task == 'ressource.cancel') {
            Joomla.submitform(task, document.getElementById('ressource-form'));
        }
        else {

            if (task != 'ressource.cancel' && document.formvalidator.isValid(document.id('ressource-form'))) {
...
if (JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
    ...
    $RessourceTag = 'ressource';
    $RessourceTitle = JText::_('RESOURCE', true);
    $DescTag = 'desc';
    ...
    $RessourceTag1 = $RessourceTag;
    $RessourceTag2 = $RessourceTitle;
    $DescTag1 = $DescTag;
    $DescTag2 = $DescTitle;
    ...
    <form
        ...
        method="post" enctype="multipart/form-data" name="adminForm" id="ressource-form" class="form-validate">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span10 form-horizontal">
                    ...
                    <!-- Open Panel Set -->
                    <?php echo JHtml::_($startPane, 'aeTab', ['active' => 'ressource']); ?>

                    <!-- Panel Event -->
                    <?php echo JHtml::_($addPanel, $aePanRessource, $RessourceTag1, $RessourceTag2); ?>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6 aeleft">
                                ...
                                <div class="control-group">
                                    <div>
                                        <img src="../<?php echo $this->item->image_bullet; ?>"
                                             style="float:right; max-width:100%; max-height:350px;"/>
                                    </div>
                                </div>
                            </div>
                        </div>
