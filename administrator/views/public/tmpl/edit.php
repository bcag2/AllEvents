...
?>
    ...
    <script type="text/javascript">
        ...
        Joomla.submitbutton = function (task) {
            if (task == 'public.cancel') {
                Joomla.submitform(task, document.getElementById('public-form'));
            }
            else {

                if (task != 'public.cancel' && document.formvalidator.isValid(document.id('public-form'))) {
...
if (JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
    ...
    $PublicTag = 'public';
    $PublicTitle = JText::_('PUBLIC', true);
    $DescTag = 'desc';
    ...
    $PublicTag1 = $PublicTag;
    $PublicTag2 = $PublicTitle;
    $DescTag1 = $DescTag;
    $DescTag2 = $DescTitle;
    ...
    <form
        ...
        method="post" enctype="multipart/form-data" name="adminForm" id="public-form" class="form-validate">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span10 form-horizontal">
                    ...
                    <!-- Open Panel Set -->
                    <?php echo JHtml::_($startPane, 'aeTab', ['active' => 'public']); ?>

                    <!-- Panel Event -->
                    <?php echo JHtml::_($addPanel, $aePanPublic, $PublicTag1, $PublicTag2); ?>
