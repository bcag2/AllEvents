...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_allevents/assets/css/allevents.css');
$document->addStyleSheet(JUri::root() . 'media/com_allevents/css/list.css');
...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_allevents&task=fieldsets.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'fieldsetList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_allevents&view=fieldsets'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="fieldsetList">
                <thead>
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_ALLEVENTS_LASTMOD', 'a.`modified_date`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                     ...
                     <i class="icon-menu"></i>
                        ...
                        <?php if (isset($this->items[0]->state)): ?>
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $item->state, $i, 'fieldsets.', $canChange, 'cb'); ?>
                            </td>
                        <?php endif; ?>
                        ...
                        <td>
                            <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'fieldsets.', $canCheckin); ?>
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_allevents&task=fieldset.edit&id=' . (int)$item->id); ?>">
