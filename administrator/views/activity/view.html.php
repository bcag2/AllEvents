 ...
 * @access    public
 */
class AllEventsViewActivity extends JViewLegacy
{
    protected $state;
    protected $item;
    protected $form;
    ...
    /**
     * AllEventsViewActivity::addToolbar()
     *
     * @throws Exception
     */
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title($isNew ? 'AllEvents <span style="font-size:14px;">- ' . JText::_('COM_ALLEVENTS_LEGEND_NEW_ACTIVITY') . '</span>' : 'AllEvents <span style="font-size:14px;">- ' . JText::_('COM_ALLEVENTS_LEGEND_EDIT_ACTIVITY') . '</span>', $isNew ? 'new' : 'pencil-2');

        $aeTitle = $isNew ? JText::_('COM_ALLEVENTS_LEGEND_NEW_ACTIVITY') : JText::_('COM_ALLEVENTS_LEGEND_EDIT_ACTIVITY');
