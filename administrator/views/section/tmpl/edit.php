...
if (JFactory::getUser()->authorise('core.satellites', 'com_allevents')) {
    ...
    $SectionTag = 'section';
    $SectionTitle = JText::_('SECTION', true);
    $DescTag = 'desc';
    ...
    $SectionTag1 = $SectionTag;
    $SectionTag2 = $SectionTitle;
    $DescTag1 = $DescTag;
    $DescTag2 = $DescTitle;
    ...
    <form
        ...
        method="post" enctype="multipart/form-data" name="adminForm" id="section-form" class="form-validate">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span10 form-horizontal">
                    ...
                    <!-- Open Panel Set -->
                    <?php echo JHtml::_($startPane, 'aeTab', ['active' => 'section']); ?>

                    <!-- Panel Event -->
                    <?php echo JHtml::_($addPanel, $aePanSection, $SectionTag1, $SectionTag2); ?>
