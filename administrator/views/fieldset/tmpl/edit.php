...
<script type="text/javascript">
    ...
    Joomla.submitbutton = function (task) {
        if (task == 'fieldset.cancel') {
            Joomla.submitform(task, document.getElementById('fieldset-form'));
        }
        else {

            if (task != 'fieldset.cancel' && document.formvalidator.isValid(document.id('fieldset-form'))) {
...
<form
    ...
    method="post" enctype="multipart/form-data" name="adminForm" id="fieldset-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', ['active' => 'general']); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ALLEVENTS_TITLE_FIELDSET', true)); ?>
        <div class="row-fluid">
