...
<form name="frmccavenue" id="frmccavenue" method="post" action="<?php echo $vars->action_url; ?>">
    ...
    <input type="hidden" name="billing_cust_state"
           value="<?php echo !empty($userInfo['state_code']) ? $userInfo['state_code'] : ''; ?>">
    <input type="hidden" name="billing_cust_city"
    ...
    <input type="hidden" name="billing_cust_tel"
           value="<?php echo !empty($userInfo['phone']) ? $userInfo['phone'] : ''; ?>">
    ...
    <input type="submit" class="btn btn-success btn-large" style="border=0;" value="<?php echo JText::_('SUBMIT'); ?>"
           alt="CCAvenue Pay"/>
