...
<div class="tjcpg-wrapper">
    <form action="<?php echo $vars->url; ?>" class="form-validate form-horizontal" onSubmit="return myValidate(this);"
          method="post">
        <div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="inputbox required" id="cardaddress1" type="text" name="cardaddress1" size="35"
                           value=""/>
                </div>
            </div>
            <div class="control-group">
