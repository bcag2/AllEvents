...
<div class="tjcpg-wrapper">
    <form action="<?php echo $vars->url ?>" class="form-validate form-horizontal" method="post" id="paymentForm"
          name="paymentForm">
        <div>
            <div>
                <div class="controls">
            ...
            <div class="form-actions">
                <input name="submit" class="btn btn-success btn-large pull-right" id="js_buy" type="button"
                       value="<?php echo JText::_('PLG_EASYSOCIALPOINT_SUBMIT'); ?>"
                       onclick="calculate(<?php echo $vars->convert_val; ?>,<?php echo $vars->amount; ?>,<?php echo $vars->user_points; ?>,<?php echo $not_enough_pts_message; ?>,<?php echo $success_message; ?>);">
