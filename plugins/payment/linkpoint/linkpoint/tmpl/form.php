    ...
    <form action="<?php echo $vars->url ?>" name="adminForm" id="adminForm" method="post"
        ...
        <div>
            ...
            <div class="controls">    <input type="text" name="creditcard_name" id="creditcard_name" size="25" class="inputbox required" value="" />
                ...
                <div class="control-group">
                    <label for="creditcard_name" class="control-label"><?php echo JText::_('Name On Card'); ?></label>
                    <div class="controls"><input type="text" name="creditcard_name" id="creditcard_name" size="25"
                                                 class="inputbox required" value=""/>
                    </div>
                </div>
                <div class="control-group">
                    <label for="creditcard_number"
                           class="control-label"><?php echo JText::_('Credit Card Number'); ?></label>
                    <div class="controls"><input type="text" name="creditcard_number" id="creditcard_number"
                ...
                <div class="control-group">
                    <label for="creditcard_code"
                           class="control-label"><?php echo JText::_('Credit Card Security Code '); ?></label>
                    <div class="controls"><input type="text" name="creditcard_code" id="creditcard_code" size="25"
                                                 class="inputbox required" value=""/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div id="tj_payGway_billInfo" style="display:<?php echo $plg_billStyle; ?>;">
                    <div class="control-group">
                        ...
                        <div class="controls"><input type="text" name="address" id="address" class="inputbox required"
                                                     value="<?php echo $wholeAddress; ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="address" class="control-label"><?php echo JText::_('City'); ?></label>
                        <div class="controls">
                            <input type="text" name="city" id="city" class="inputbox required"
