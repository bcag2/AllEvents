    ...
    <form action="<?php echo $vars->url ?>" name="adminForm" id="adminForm" method="post"
        ...
        <div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                    <input type="text" name="creditcard_name" id="creditcard_name" size="25" class="inputbox required"
                           value=""/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div id="tj_payGway_billInfo" style="display:<?php echo $plg_billStyle; ?>;">
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                        <input type="text" name="address" id="address" class="inputbox required"
                ...
                <div class="form-group">
                    <label for="state"
                           class="col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label"><?php echo JText::_('State'); ?></label>
                    <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
