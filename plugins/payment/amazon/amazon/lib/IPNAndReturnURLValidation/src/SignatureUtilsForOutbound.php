...
class SignatureUtilsForOutbound
{
    ...
    static $public_key_cache = [];

    /**
     * SignatureUtilsForOutbound constructor.
     */
     ...
     * @param should $urlEndPoint
     * @param should $httpMethod
     *
     * @return SimpleXMLElement
     * @throws Exception
     * @throws SignatureException
     * @internal param $parameters - all the http parameters sent in IPNs or return urls.
     * @internal param should $urlEndPoint be the url which recieved this request.
     * @internal param should $httpMethod be either POST (IPNs) or GET (returnUrl redirections)
