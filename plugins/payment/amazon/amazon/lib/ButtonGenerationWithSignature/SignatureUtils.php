...
class SignatureUtils
{
     ...
     * @return string
     * @throws Exception
     * @internal   param $key - Secret key
     * @internal   param $httpMethod - httpMethos used
     * @internal   param $host - Host
     * @requestURi -  Path
     */
    ...
    private static function _calculateStringToSignV2(array $parameters, $httpMethod, $hostHeader, $requestURI)
    {
        ...
        $uriencoded = implode("/", array_map(["SignatureUtils", "_urlencode"], explode("/", $requestURI)));
        $data .= $uriencoded;
        $data .= "\n";
