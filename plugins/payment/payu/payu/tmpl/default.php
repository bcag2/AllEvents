...
<div class="tjcpg-wrapper">
    <form action="<?php echo $vars->action_url ?>" class="form-horizontal" method="post">
        ...
        <input type="hidden" name="Firstname"
               value="<?php if ($vars->user_firstname) echo trim($vars->user_firstname); ?>"/>
        ...
        <div class="form-actions">
            <input type="submit" class="btn btn-success btn-large" style="border=0;"
                   value="<?php echo JText::_('PAYU_SUBMIT'); ?>" alt="PayU India"/>
        </div>
    </form>
</div>
