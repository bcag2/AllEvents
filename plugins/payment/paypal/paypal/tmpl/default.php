...
<div class="tjcpg-wrapper">
    <form name="tj_Plug_PaypalForm" action="<?php echo $vars->action_url; //$vars->submiturl; //$vars->action_url ?>"
        ...
        <div class="form-actions">
            <input type="submit" class="btn btn-success btn-large"
                   src="https://www.paypal.com/en_US/i/btn/x-click-but02.gif" style="border=0;"
