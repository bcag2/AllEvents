...
class PlgPaymentPaypal extends JPlugin
{
    ...
    {
        $plgPaymentPaypalHelper = new plgplgPaymentPaypalHelper;
    ...
    {
        // Print_r($data);die('Restricted access');
    ...
    public function onTP_Storelog($data)
    {
        ...
        if ($log_write == 1) {
            plgPaymentPaypalHelper::Storelog($this->_name, $data);
        }
    }
}
