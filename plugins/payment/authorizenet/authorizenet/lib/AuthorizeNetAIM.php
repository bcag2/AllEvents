...
class AuthorizeNetAIM extends AuthorizeNetRequest
{
     ...
     */
    private $_all_aim_fields = ["address", "allow_partial_auth", "amount",
     ...
     *
     * @param bool|string $amount The dollar amount to charge
     * @param bool|string $card_num The credit card number
     * @param bool|string $exp_date CC expiration date
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetARB_Response
     */
     ...
     *
     * @param bool|string $trans_id Transaction id to charge
     * @param bool|string $amount Dollar amount to charge if lesser than auth
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetARB_Response
     */
     ...
     * tender, then set x_split_tender_id manually.)
     *
     * @param bool|string $trans_id Transaction id to void
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetARB_Response
     */
     ...
     *
     * @param bool|string $auth_code The auth code
     * @param bool|string $amount The dollar amount to charge
     * @param bool|string $card_num The last 4 of credit card number
     * @param bool|string $exp_date CC expiration date
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetARB_Response
     */
     ...
     *
     * @param bool|string $trans_id Transaction id to credit
     * @param bool|string $amount The dollar amount to credit
     * @param bool|string $card_num The last 4 of credit card number
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetARB_Response
     */
     ...
     * @param        $bank_aba_code
     * @param        $bank_acct_num
     * @param        $bank_acct_type
     * @param        $bank_name
     * @param        $bank_acct_name
