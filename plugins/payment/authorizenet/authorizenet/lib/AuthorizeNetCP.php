...
class AuthorizeNetCP extends AuthorizeNetAIM
{
     ...
     *
     * @return AuthorizeNetAIM_Response|AuthorizeNetCP_Response
     */
    protected function _handleResponse($response)
    {
        return new AuthorizeNetCP_Response($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->custom_fields);
    }
...
class AuthorizeNetCP_Response extends AuthorizeNetResponse
{
     ...
     *
     * @param bool|string $api_login_id
     * @param bool|string $md5_setting
     *
     * @return bool
     */
