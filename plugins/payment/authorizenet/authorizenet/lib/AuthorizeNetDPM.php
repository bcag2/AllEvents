        ...
        <form method="post" action="' . $post_url . '">
            ...
            <fieldset>
                <div>
                    ...
                    <input type="text" class="text" size="15" name="x_card_num" value="' . ($prefill ? '6011000000000012' : '') . '"/>
                </div>
                <div>
                    <label>Exp.</label>
                    <input type="text" class="text" size="4" name="x_exp_date" value="' . ($prefill ? '04/17' : '') . '"/>
                </div>
                <div>
                    <label>CCV</label>
                    <input type="text" class="text" size="4" name="x_card_code" value="' . ($prefill ? '782' : '') . '"/>
                </div>
            </fieldset>
            <fieldset>
                <div>
                    <label>First Name</label>
                    <input type="text" class="text" size="15" name="x_first_name" value="' . ($prefill ? 'John' : '') . '"/>
                </div>
                <div>
                    <label>Last Name</label>
                    <input type="text" class="text" size="14" name="x_last_name" value="' . ($prefill ? 'Doe' : '') . '"/>
                </div>
            </fieldset>
            <fieldset>
                <div>
                    <label>Address</label>
                    <input type="text" class="text" size="26" name="x_address" value="' . ($prefill ? '123 Main Street' : '') . '"/>
                </div>
                <div>
                    <label>City</label>
                    <input type="text" class="text" size="15" name="x_city" value="' . ($prefill ? 'Boston' : '') . '"/>
                </div>
            </fieldset>
            <fieldset>
                <div>
                    <label>State</label>
                    <input type="text" class="text" size="4" name="x_state" value="' . ($prefill ? 'MA' : '') . '"/>
                </div>
                <div>
                    <label>Zip Code</label>
                    <input type="text" class="text" size="9" name="x_zip" value="' . ($prefill ? '02142' : '') . '"/>
                </div>
                <div>
                    <label>Country</label>
                    <input type="text" class="text" size="22" name="x_country" value="' . ($prefill ? 'US' : '') . '"/>
                </div>
            </fieldset>
