...
class AuthorizeNetTD extends AuthorizeNetRequest
{
     ...
     * @param bool|string $firstSettlementDate //  yyyy-mmddTHH:MM:SS
     * @param bool|string $lastSettlementDate //  yyyy-mmddTHH:MM:SS
     * @param bool $utc //  Use UTC instead of merchant time zone setting
     *
     * @return AuthorizeNetARB_Response|AuthorizeNetTD_Response
     */
     ...
     *
     * @return AuthorizeNetTD_Response|AuthorizeNetTransactionDetails_Response
     */
