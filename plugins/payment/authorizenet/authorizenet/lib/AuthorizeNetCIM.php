...
class AuthorizeNetCIM extends AuthorizeNetRequest
{
     ...
     *
     * @param        object AuthorizeNetCustomer $customerProfile
     * @param string $validationMode
     *
     * @return AuthorizeNetARB_Response|AuthorizeNetCIM_Response
     */
     ...
     * @param        object AuthorizeNetPaymentProfile $paymentProfile
     * @param string $validationMode
     *
     * @return AuthorizeNetARB_Response|AuthorizeNetCIM_Response
     */
     ...
     *
     * @param int $customerProfileId
     * @param     object AuthorizeNetAddress $shippingAddress
     *
     * @return AuthorizeNetARB_Response|AuthorizeNetCIM_Response
     */
     ...
     * @param        object AuthorizeNetTransaction $transaction
