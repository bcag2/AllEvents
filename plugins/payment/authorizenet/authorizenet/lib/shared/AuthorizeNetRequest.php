...
abstract class AuthorizeNetRequest
{
    ...
    protected $_post_string; // Set to false if getting connection errors.
     ...
     * Constructor.
     *
     * @param bool|string $api_login_id The Merchant's API Login ID.
     * @param bool|string $transaction_key The Merchant's Transaction Key.
     */
