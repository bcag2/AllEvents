...
<table class="userlist">
    ...
    <tr>
        <td class="title">
            <form name="adminForm" id="adminForm" class="form-validate form-horizontal" name="recurrform"
                  onSubmit="return myValidate(this);" action="<?php echo $vars->url; ?>" method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" class="inputbox required" name="sub_name" id="sub_name"
                                   value="<?php echo $vars->item_name; ?>">
                    ...
                    <tr>
                        <div class="form-actions">
                            <td colspan="2" align="center">
                                ...
                                <input type="hidden" class="inputbox required" name="amount" size="10"
                                       value="<?php echo $vars->amount; ?>"/>
                                <input type="hidden" class="inputbox required" name="startDate" size="10"
                                       value="<?php echo $vars->recurring_startdate; ?>"/>
                                <input type="hidden" class="inputbox required" name="totalOccurrences" size="10"
                                       value="<?php echo $vars->recurring_payment_interval_totaloccurances; ?>"/>
                                <input type="hidden" class="inputbox required" name="intervalLength" size="10"
                                       value="<?php echo $vars->recurring_payment_interval_length; ?>"/>
                                <input type="hidden" class="inputbox required" name="intervalUnit" size="10"
                                       value="<?php echo $vars->recurring_payment_interval_unit; ?>"/>
                                ...
                                <input type="hidden" class="inputbox required" name="order_id" size="10"
                                       value="<?php echo $vars->order_id; ?>"/>
                                <input type="hidden" name="payment_type" value="recurring"/>
                                <input type="hidden" name="plugin_payment_method" value="onsite"/>
                                <input type="submit" name="submit" id="submit"
                                       value="<?php echo JText::_('MAKE_PAYMENT'); ?>"/>
                        </div>
                        </td>
                    </tr>
