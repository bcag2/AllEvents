        ...
        <div>
            ...
            <div id="tj_payGway_billInfo" style="display:<?php echo $plg_billStyle; ?>;">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardfname" type="text" name="cardfname" size="35"
                ...
                <div class="control-group">
                    ...
                    <div class="controls"><input class="inputbox required" id="cardlname" type="text" name="cardlname"
                                                 size="35"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardaddress1" type="text" name="cardaddress1" size=""
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox" id="cardaddress2" type="text" name="cardaddress2" size="45"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardcity" type="text" name="cardcity" size="35"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardstate" type="text" name="cardstate" size="10"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardzip" type="text" name="cardzip" size="10"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="cardcountry" type="text" name="cardcountry" size="35"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="inputbox required" id="email" type="text" name="email" size="35"
