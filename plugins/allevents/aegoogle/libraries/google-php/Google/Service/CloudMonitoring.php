...
class Google_Service_CloudMonitoring_MetricDescriptors_Resource extends Google_Service_Resource
{
     ...
     * @param Google_MetricDescriptor|Google_Service_CloudMonitoring_MetricDescriptor $postBody
    ...
    public function create($project, Google_Service_CloudMonitoring_MetricDescriptor $postBody, $optParams = [])
    {
        ...
        return $this->call('create', [$params], "Google_Service_CloudMonitoring_MetricDescriptor");
    }
    ...
    public function delete($project, $metric, $optParams = [])
    {
        ...
        return $this->call('delete', [$params], "Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse");
    }
    ...
    public function listMetricDescriptors($project, $optParams = [])
    {
        ...
        return $this->call('list', [$params], "Google_Service_CloudMonitoring_ListMetricDescriptorsResponse");
    }
}
...
class Google_Service_CloudMonitoring_Timeseries_Resource extends Google_Service_Resource
{
    ...
    {
        $params = ['project' => $project, 'metric' => $metric, 'youngest' => $youngest];
        $params = array_merge($params, $optParams);

        return $this->call('list', [$params], "Google_Service_CloudMonitoring_ListTimeseriesResponse");
    }
     ...
     * @param string $project The project ID. The value can be the numeric project
     *                                                                                                       ID or string-based project name.
     * @param Google_Service_CloudMonitoring_WriteTimeseriesRequest|Google_WriteTimeseriesRequest $postBody
     * @param array $optParams Optional parameters.
     *
     * @return expected_class|Google_Http_Request
     */
    public function write($project, Google_Service_CloudMonitoring_WriteTimeseriesRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('write', [$params], "Google_Service_CloudMonitoring_WriteTimeseriesResponse");
    }
}
...
class Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource extends Google_Service_Resource
{
    ...
    public function listTimeseriesDescriptors($project, $metric, $youngest, $optParams = [])
    {
        ...
        return $this->call('list', [$params], "Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse");
    }
}


/**
 * Class Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListMetricDescriptorsRequest
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListMetricDescriptorsResponse
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListTimeseriesDescriptorsRequest
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListTimeseriesRequest
 */
...
/**
 * Class Google_Service_CloudMonitoring_ListTimeseriesResponse
 */
...
/**
 * Class Google_Service_CloudMonitoring_MetricDescriptor
 */
class Google_Service_CloudMonitoring_MetricDescriptor extends Google_Collection
{
    ...
    /**
     * @param Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor $typeDescriptor
     */
...
/**
 * Class Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor
 */
...
/**
 * Class Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor
 */
...
/**
 * Class Google_Service_CloudMonitoring_Point
 */
class Google_Service_CloudMonitoring_Point extends Google_Model
{
    ...
    /**
     * @param Google_Service_CloudMonitoring_PointDistribution $distributionValue
     */
...
/**
 * Class Google_Service_CloudMonitoring_PointDistribution
 */
class Google_Service_CloudMonitoring_PointDistribution extends Google_Collection
{
    ...
    /**
     * @param Google_Service_CloudMonitoring_PointDistributionOverflowBucket $overflowBucket
     */
    ...
    /**
     * @param Google_Service_CloudMonitoring_PointDistributionUnderflowBucket $underflowBucket
     */
...
/**
 * Class Google_Service_CloudMonitoring_PointDistributionBucket
 */
...
/**
 * Class Google_Service_CloudMonitoring_PointDistributionOverflowBucket
 */
...
/**
 * Class Google_Service_CloudMonitoring_PointDistributionUnderflowBucket
 */
...
/**
 * Class Google_Service_CloudMonitoring_Timeseries
 */
class Google_Service_CloudMonitoring_Timeseries extends Google_Collection
{
    ...
    /**
     * @param Google_Service_CloudMonitoring_TimeseriesDescriptor $timeseriesDesc
     */
...
/**
 * Class Google_Service_CloudMonitoring_TimeseriesDescriptor
 */
...
/**
 * Class Google_Service_CloudMonitoring_TimeseriesDescriptorLabel
 */
...
/**
 * Class Google_Service_CloudMonitoring_TimeseriesDescriptorLabels
 */
...
/**
 * Class Google_Service_CloudMonitoring_TimeseriesPoint
 */
class Google_Service_CloudMonitoring_TimeseriesPoint extends Google_Model
{
    ...
    /**
     * @param Google_Service_CloudMonitoring_Point $point
     */
...
/**
 * Class Google_Service_CloudMonitoring_WriteTimeseriesRequest
 */
...
/**
 * Class Google_Service_CloudMonitoring_WriteTimeseriesRequestCommonLabels
 */
...
/**
 * Class Google_Service_CloudMonitoring_WriteTimeseriesResponse
 */
